...
The template is already filled with dummy data, to give users an [impression how it looks like](https://github.com/JoshuaLampert/clean-math-paper/blob/main/template/main.pdf). The paper is obtained by compiling `main.typ`.
